...
contract SubmitToMiningSharesGateV2Test is SharedMiningPoolV2Base {
    /// @notice This test verifies submitToMining reverts with `NoSharesForEpoch` when `totalActiveShares == 0`.
    function testSubmitToMiningRevertsWhenNoSharesExist() external {
